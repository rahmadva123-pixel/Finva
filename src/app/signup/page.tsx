      ...
      <CardContent className="px-4 pb-4 sm:px-6 sm:pb-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="relative">
              ...
              <Button type="button" variant="ghost" size="icon" className="absolute right-1 top-1/2 h-10 !w-10 -translate-y-1/2 rounded-md text-muted-foreground" onClick={() => setShowPassword((value) => !value)} aria-label={showPassword ? "Hide password" : "Show password"}>
            ...
            <div className="relative">
              ...
              <Button type="button" variant="ghost" size="icon" className="absolute right-1 top-1/2 h-10 !w-10 -translate-y-1/2 rounded-md text-muted-foreground" onClick={() => setShowConfirmPassword((value) => !value)} aria-label={showConfirmPassword ? "Hide confirm password" : "Show confirm password"}>
