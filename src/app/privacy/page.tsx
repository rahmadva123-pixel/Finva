                 ...
                 if (docSnap.exists() && docSnap.data().privacy) {
                    ...
                    // Ensure sections is an array and has a type
                     if (Array.isArray(data.sections)) {
                        ...
                        data.sections = [{id: '1', title: 'Privacy Details', type: 'markdown', description: data.content || 'Our privacy policy details will be listed here.'}];
                    }
                    setPageData(data);
                } else {
                    setPageData({
                        title: "Privacy Policy",
                        sections: [{id: '1', title: 'Data Collection', type: 'markdown', description: "Our privacy policy details will be listed here."}],
                    });
                }
            } catch (error) {
